...
@SpringBootTest(classes = { YourStoriesAuthorizationServerApplication.class, TestDbConfig.class, TestIntegrationConfig.class }, webEnvironment = WebEnvironment.RANDOM_PORT)
@Transactional
